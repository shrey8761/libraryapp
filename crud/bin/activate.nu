...
def-env activate-virtualenv [] {
    ...
    let virtual_env = '/Users/shrey/Downloads/projects/django crud/crud'
    let bin = 'bin'
    let path_sep = ':'
...
alias deactivate = source '/Users/shrey/Downloads/projects/django crud/crud/bin/deactivate.nu'
